...
const WhatsAppLawEnforcementAnalytics = () => {
  ...
  const loadStats = async () => {
    try {
      setLoading(true);
      setError(null);
      const data = await whatsapp.getThreatStats();
      setStats(data);
    } catch (err) {
    ...
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="text-lg font-medium text-gray-900">Law Enforcement Analytics (WhatsApp)</h3>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-700 font-medium">Safe Messages</p>
            </div>
            <div className="text-2xl">✅</div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-lg font-semibold text-gray-700">{stats.mediumRiskMessages}</p>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-3">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-lg font-semibold text-gray-700">{stats.lowRiskMessages}</p>
      ...
      <div className="border-t pt-4">
        <div className="flex items-center justify-between">
          ...
          <button className="text-sm bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md">📋 Export Evidence</button>
        </div>
      </div>
    </div>
  );
...
export default WhatsAppLawEnforcementAnalytics; 